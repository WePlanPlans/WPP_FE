...
const Alert: FC<AlertProps> = ({
  ...
  <Dialog.Root>
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="fixed left-[50%] top-[50%] z-[130] flex h-[192px] w-[346px] translate-x-[-50%] translate-y-[-50%] flex-col items-center justify-center rounded-[16px] bg-white shadow-lg focus:outline-none">
